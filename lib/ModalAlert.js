...
class ModalAlert extends React.Component {
        ...
        if (this.props.header) {
            if (this.props.header instanceof String || typeof this.props.header === "string") {
                return (React.createElement(react_bootstrap_1.Modal.Header, { closeButton: true },
                    React.createElement(react_bootstrap_1.Modal.Title, { id: this.props.modalId || "alert" }, this.props.header)));
            }
            else {
    ...
    render() {
        ...
        return (React.createElement(react_bootstrap_1.Modal, { show: this.props.show, onHide: this.props.onCancel, bsSize: bsSize, "aria-labelledby": this.props.modalId || "alert" },
            this.renderHeader(),
