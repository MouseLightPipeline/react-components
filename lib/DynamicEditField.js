        ...
        if (this.state.mode === DynamicEditFieldMode.Edit) {
            return (React.createElement(react_bootstrap_1.FormGroup, { style: style },
                React.createElement(react_bootstrap_1.InputGroup, { bsSize: "sm" },
                    ...
                    React.createElement(react_bootstrap_1.FormControl, { type: "text", style: this.state.feedback ? { color: "red" } : {}, value: this.format(this.state.value), placeholder: this.props.placeHolder, onKeyPress: (evt) => this.onKeyPress(evt), onChange: (evt) => this.onValueChanged(evt) }),
                    React.createElement(react_bootstrap_1.InputGroup.Button, null,
