...
class DynamicSelect extends React.Component {
    ...
    renderSelect(selected, options, isInputGroup = false) {
        ...
        return this.props.useVirtualized ? (React.createElement(react_virtualized_select_1.default, { name: `${this.props.idName}-select`, placeholder: this.props.placeholder || "Select...", value: selected, options: options, clearable: this.props.clearable, disabled: this.props.disabled, multi: this.props.multiSelect, style: style, filterOption: (option, filter) => this.filterOption(option, filter), filterOptions: (options, filterValue, currentValues) => this.filterOptions(options, filterValue, currentValues), onChange: (option) => this.onSelectChange(option) })) : (React.createElement(ReactSelectClass, { name: `${this.props.idName}-select`, placeholder: this.props.placeholder || "Select...", value: selected, options: options, clearable: this.props.clearable, disabled: this.props.disabled, multi: this.props.multiSelect, style: style, filterOption: (option, filter) => this.filterOption(option, filter), filterOptions: (options, filterValue, currentValues) => this.filterOptions(options, filterValue, currentValues), onChange: (option) => this.onSelectChange(option) }));
    }
    renderAddButton() {
